  ...
  return (
    <div>
      <label className="block text-xs font-medium mb-1.5">
        Target Subjects <span className="text-slate-400 font-normal">(Choose Only One)</span>
      </label>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition flex items-center gap-1.5 ${
                isSelected
                  ...
                  : isDark ? 'border-slate-700 bg-slate-950 text-slate-400 hover:border-slate-700' 
      ...
      <input
        ...
        className={`w-full px-4 py-2.5 rounded-xl border text-xs outline-none focus:ring-2 focus:ring-indigo-500 transition ${
        ...
        <div className="mt-3 flex flex-wrap gap-1.5 items-center">
          ...
          {selectedSubjects.map((s) => (
            <span
              ...
              text-xs font-medium bg-indigo-500 text-white"
            >
              {s}
