...
const SignUpVerificationScreen: React.FC = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsVerifying(true);
    try {
      const response = await otpAuth.verifySignUpOtp({ email, otp: enteredOtp });
  ...
  const handleResendOtp = async () => {
    ...
    setIsResending(true);
    try {
      const response = await otpAuth.resendSignUpOtp({ email });
